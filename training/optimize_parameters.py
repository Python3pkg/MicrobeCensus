...
genomes_dir = os.path.join(main_dir, 'training/input/genomes')
reads_dir   = os.path.join(main_dir, 'training/intermediate/reads')
hits_dir    = os.path.join(main_dir, 'training/intermediate/hits')
pars_path   = os.path.join(main_dir, 'training/output/pars.map')
coeffs_path = os.path.join(main_dir, 'training/output/coefficients.map')
